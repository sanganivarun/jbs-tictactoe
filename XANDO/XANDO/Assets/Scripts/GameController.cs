...
public class GameController : MonoBehaviour
{
    ...
    public void CheckWinner()
    {
        ...
        else
        {
            ...
            {
                GameOverUIManager.GOUI.SetWinner(WINNER.DRAW);
            }
        }
    }
    ...
    public void DeclareWinner()
    {
        ...
        if (turn % 2 == 0)
        {
            GameOverUIManager.GOUI.SetWinner(WINNER.XWINS);
            GameMaster.GM.IncrementScore(1, AIController.AIC.gameMode);
        }
        else
        {
            GameOverUIManager.GOUI.SetWinner(WINNER.OWINS);
            GameMaster.GM.IncrementScore(0, AIController.AIC.gameMode);
        }
    }
